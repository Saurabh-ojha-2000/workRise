  ...
  const data = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Selling on WorkRise", link: "#" },
        { name: "Buying on WorkRise", link: "#" },
      ],
    },
    {
    ...
    {
      headerName: "Move From WorkRise",
      links: [
        { name: "WorkRise Business", link: "#" },
        { name: "WorkRise Pro", link: "#" },
        { name: "WorkRise Logo Maker", link: "#" },
        { name: "WorkRise Guides", link: "#" },
        { name: "Get Inspired", link: "#" },
        { name: "WorkRise Select", link: "#" },
        { name: "ClearVoice", link: "#" },
        { name: "WorkRise Workspace", link: "#" },
        { name: "Learn", link: "#" },
